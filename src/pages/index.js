        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl  text-center lg:py-16 lg:px-12">
            ...
            <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                ...
                <div className="flex flex-wrap  items-center mt-8 text-gray-500 justify-center sm:justify-between mb-5">
                    <a href="https://www.producthunt.com/posts/octobear-hub?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-octobear&#0045;hub" target="_blank" className="hover:text-gray-800 dark:hover:text-gray-400" rel="noreferrer">
                    ...
                    <a href="https://github.com/OctobearHub/octobear.org" target="_blank" className="flex justify-end" rel="noreferrer">
                        <Image src="/github-button.svg" alt="Octobear Github" width="200" height="54" />                
                    </a>
                    <a href="https://discord.gg/6hacRDmfxZ" target="_blank" className=" hover:text-gray-800 dark:hover:text-gray-400 flex justify-end" rel="noreferrer">
                        <Image src="/discord-button.svg" alt="Octobear discord" width="200" height="54" />                
                    </a>
                </div>
            </div>
